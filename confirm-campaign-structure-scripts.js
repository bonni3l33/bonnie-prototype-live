...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const nextBtn = document.getElementById('continue-to-segmentation');
  ...
  if (nextBtn) {
    nextBtn.addEventListener('click', function() {
      console.log('Continue to Segmentation');

      // Store campaign structure data for next step
      const campaignData = {
        parentName: 'National wide NPWS',
        parentPromo: '40% OFF',
        children: [
          { name: 'Hot markets - NYC', promo: '50% OFF', targeting: 'NYC', placements: ['Push', 'Email', 'Hub'] },
          { name: 'Hot markets - LA', promo: '50% OFF', targeting: 'LA', placements: ['Push', 'Email', 'Hub'] },
          { name: 'Hot markets - Chicago', promo: '50% OFF', targeting: 'Chicago', placements: ['Push', 'Email', 'Hub'] },
          { name: 'Hot markets - Miami', promo: '50% OFF', targeting: 'Miami', placements: ['Push', 'Email', 'Hub'] }
        ]
      };

      sessionStorage.setItem('campaignStructure', JSON.stringify(campaignData));
